package exam_problems.p13_lambda_functional_interface;
    ...
    public static Evaluator build(Evaluator.TYPE type) throws InvalidEvaluation {
        ...
        switch (type) {
            case NO_CRIMINAL_RECORD:
                return (Applicant a) -> !a.hasCriminalRecord();
            case MORE_EXPERIENCE:
                return (Applicant a) -> a.getEmploymentYears() >= 10;
            case MORE_CREDIT_SCORE:
                return (Applicant a) -> a.getCreditScore() >= 500;
            case NO_CRIMINAL_RECORD_AND_MORE_EXPERIENCE:
                return (Applicant a) -> a.getEmploymentYears() >= 10 && !a.hasCriminalRecord();
            case MORE_EXPERIENCE_AND_MORE_CREDIT_SCORE:
                return (Applicant a) -> a.getEmploymentYears() >= 10 && a.getCreditScore() >= 500;
            case NO_CRIMINAL_RECORD_AND_MORE_CREDIT_SCORE:
                return (Applicant a) -> a.getCreditScore() >= 500 && !a.hasCriminalRecord();
            default:
