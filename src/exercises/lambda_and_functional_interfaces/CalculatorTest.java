...
class OperationFactory {
    ...
    private static final OperationNew ADD = (r, v) -> r + v;
    private static final OperationNew SUBTRACT = (r, v) -> r - v;
    private static final OperationNew MULTIPLY_OP = (r, v) -> r * v;
    private static final OperationNew DIVIDE_OP = (r, v) -> r / v;

    // Factory method that returns the correct operation
    public static OperationNew getOperation(char operator) throws UnknownOperatorException {
        if (operator == PLUS) {
            return ADD;
...
class Calculator {
    ...
    public String execute(char operator, double value) throws UnknownOperatorException {
        OperationNew op = OperationFactory.getOperation(operator);
